...
public class ApplicationConfig {
    ...
    SessionFactory sessionFactory(){
        ...
        var factory = new HibernatePersistenceConfiguration("planuni")
                .managedClasses(Address.class,Campus.class, Consumer.class, Course.class, Degree.class,Plan.class, Prerequisite.class, Requirement.class, PlannedCourse.class,PlanDegrees.class)
